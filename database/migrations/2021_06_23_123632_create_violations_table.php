...
class CreateViolationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('violations', function (Blueprint $table) {
            ...
            $table->foreignId('area_res_id')->nullable()->constrained('workers')->onUpdate('cascade')->onDelete('no action');
            $table->foreignId('classification')->constrained('violation_types')->onUpdate('cascade')->onDelete('no action');
