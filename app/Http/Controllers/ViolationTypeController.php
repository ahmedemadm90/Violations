...
class ViolationTypeController extends Controller
{
    ...
    {
        $this->middleware('permission:Violation Classifications List|Violation Classifications Create|Violation Classifications Edit|Violation Classifications Delete', ['only' => ['index', 'store']]);
        $this->middleware('permission:Violation Classifications Create', ['only' => ['create', 'store']]);
        $this->middleware('permission:Violation Classifications Edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:Violation Classifications Destroy', ['only' => ['destroy']]);
    }
    /**
    ...
    {
        $classification = ViolationType::find($id);
        $classification->delete();
        return redirect(route('classifications.index'))->with(['success','deleted successfully']);
    }
}
