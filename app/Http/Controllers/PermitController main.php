...
class PermitController extends Controller
{
    ...
    {
        $this->middleware(
            'permission:Permits List|Permit Create|Permit Edit|Permit Delete|Request Truck Permit|
    ...
    function index()
    {
        $permits = Permit::orderBy('created_at', 'desc')->Paginate(50);
...
/* End Safety Functions
    ...
    function myPermit()
    {
        $permits = Permit::where('requested_by', Auth::user()->id)->paginate(50);
    ...
    public function truckmyteam()
    {
        ...
        return view('permits.vehicles.group', compact('permits'));
    }
    public function privatemyteam()
    {
        ...
        return view('permits.private.group', compact('permits'));
    }
     Start Group Functions */
