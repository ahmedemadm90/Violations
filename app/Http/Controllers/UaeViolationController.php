...
class UaeViolationController extends Controller
{
    ...
    {
        $this->middleware('permission:Uae Violations List|Uae Violations Create|Uae Violations Edit|Uae Violations Destroy', ['only' => ['index', 'store']]);
        $this->middleware('permission:Uae Violations Create', ['only' => ['create', 'store']]);
        $this->middleware('permission:Uae Violations Edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:Uae Violations Destroy', ['only' => ['destroy']]);
        $this->middleware('permission:Export All Uae Violations', ['only' => ['export']]);
        $this->middleware('permission:Export Date Results Uae Violations', ['only' => ['exportDate']]);
        $this->middleware('permission:Search By Date Uae Violations', ['only' => ['indexDate']]);
    }
    /**
    ...
    {
        $uae = Country::where('country_name', 'uae')->first();
        $vps = Vp::where('region_id', $uae->id)->get();
