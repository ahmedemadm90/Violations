...
class ServiceCompanyController extends Controller
{
    ...
    {
        $this->middleware('permission:Service Companies List|Service Companies Create|Service Companies Edit|Service Companies Destroy|Service Company Show', ['only' => ['index', 'store']]);
        $this->middleware('permission:Service Companies List', ['only' => ['index']]);
        $this->middleware('permission:Service Companies Create', ['only' => ['create', 'store']]);
        $this->middleware('permission:Service Companies Edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:Service Companies Destroy', ['only' => ['destroy']]);
        $this->middleware('permission:Service Companies Show', ['only' => ['show']]);
    }
