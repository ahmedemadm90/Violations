                ...
                @can('CLM')
                    <li class="sidebar-item has-sub">
                        ...
                        <ul class="submenu ">
                            ...
                            @endcan
                            @can('My Permits State')
                                <li>
                                    <a href="{{ route('permits.mypermits') }}"
                                        class="text-decoration-none">{{ __('My Permits State') }}</a>
                                </li>
                            @endcan
                            @can('My Unfixed Permits State')
                                <li>
                                    <a href="{{ route('permits.myunfixedpermits') }}"
                                        class="text-decoration-none">{{ __('My Unfixed Permits State') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
