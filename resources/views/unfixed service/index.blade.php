...
@section('content')
    <hr class="">
    @can('Unfixed Workers Create')

        <a class="btn btn-success" href="{{ route('unfixed.emp.create') }}"> {{ __('Create New Worker') }}</a>
        <a class="btn btn-primary" href="{{ route('unfixed.export') }}"> {{ __('export unfixed') }}</a>
    @endcan
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenuButton1">
                            ...
                            @can('Unfixed Service Emp Delete')
                                <li><a class="dropdown-item" href="{{ route('unfixed.emp.destroy', $emp->id) }}">Remove</a>
                                </li>
                            @endcan
                        </ul>
                    </div>
